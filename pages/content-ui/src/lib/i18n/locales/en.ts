...
export const en: LocaleMessages = {
  ...
  loginPanel: {
    ...
    walletDisconnected: 'Wallet disconnected. Reconnect to continue.',
  },
  alpha: {
  ...
  myPoints: {
    ...
    points: 'Points',
    waitingConfirmation: 'Waiting for chain confirmation...',
    walletReconnecting: 'Reconnecting wallet...',
    walletReconnected: 'Wallet reconnected',
    reconnectCancelled: 'Wallet connection cancelled',
    reconnectFailed: 'Failed to reconnect wallet',
    stripe: {
      cardLabel: 'Card',
      notAvailable: 'Card payment is not available yet.',
      invalidPackage: 'Invalid package selected.',
      upstreamError: 'Payment service is temporarily unavailable. Please try again later.',
      pendingLimit: 'You have too many unfinished orders. Please complete them before starting a new one.',
      resumingPayment: 'You already have an unfinished order for this package. Opening its payment page...',
      tooManyRequests: 'Too many requests. Please wait a moment and try again.',
      popupBlocked: 'The payment page could not be opened. Please allow pop-ups for this site and try again.',
    },
  },
  stripeResult: {
    confirming: 'Payment confirming...',
    confirmingDesc:
      'Your payment is being processed. Delayed payment methods (e.g. bank transfer) may take longer. This page will update automatically.',
    success: 'Payment successful!',
    successDesc: '{{points}} points and {{llax}} LLAx have been added to your account.',
    cancelled: 'Payment not completed',
    cancelledDesc: 'The payment was not completed. No charges were made.',
    timeout: 'Still confirming',
    timeoutDesc: 'Your payment is taking longer than expected. You can refresh the status later.',
    notFound: 'Order not found',
    notFoundDesc: 'No recent card payment order was found for your account.',
    backToPoints: 'Back to My Points',
    retry: 'Try Again',
  ...
  claim: {
    ...
    claiming: 'Claiming...',
    claimSuccess: 'LLAx claimed successfully!',
    claimFailed: 'Claim failed',
    stepCheckBalance: 'Checking balance...',
    stepFetchNonce: 'Fetching claim nonce...',
    stepSignMessage: 'Please sign the message in your wallet',
    stepSubmitClaim: 'Submitting claim request...',
    stepSwitchChain: 'Switching to BSC network...',
    stepExecuteContract: 'Executing claim transaction...',
    stepWaitReceipt: 'Waiting for transaction confirmation...',
    stepConfirmClaim: 'Confirming claim...',
    stepSuccess: 'Claim successful!',
    historyTitle: 'History',
    historyEmpty: 'No claim history',
    ...
    frozenAmount: 'Frozen',
    frozenTip:
      'Frozen balance is usually caused by cancelling a wallet transaction during claiming. Please wait for the pending claim to complete.',
  },
};
